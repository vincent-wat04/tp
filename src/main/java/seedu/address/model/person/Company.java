...
public class Company {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Company names can take any values, and it can be blank";

    /*
     * Company can be any string, including empty string.
     * The first character of the company must not be a whitespace if non-empty,
